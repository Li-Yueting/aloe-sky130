...
# Executed on 12:00:31 PM(May09) by user: xingyuni
...
set vars(check_setup_errors) {{File does not exist (inputs/adk/rtk-stream-out.map)}}
...
set vars(lef_files) {inputs/adk/rtk-tech.lef inputs/adk/stdcells.lef inputs/adk/rtk-tech.lef inputs/adk/stdcells.lef}
set vars(library_sets) {libs_typical}
set vars(libs_typical,timing) {inputs/adk/stdcells.lib}
...
set vars(route,route_design,replace_tcl) {innovus-foundation-flow/custom-scripts/route-design-check.tcl}
...
set vars(tagged) {init,save_design,replace_tcl place,restore_design,skip place,save_design,replace_tcl cts,set_ccopt_mode,skip cts,restore_design,skip cts,save_design,replace_tcl postcts_hold,restore_design,skip postcts_hold,save_design,replace_tcl route,check_place,skip route,route_design,replace_tcl route,time_design,skip route,restore_design,skip route,save_design,replace_tcl postroute,restore_design,skip postroute,save_design,replace_tcl signoff,stream_out,replace_tcl signoff,summary_report,replace_tcl signoff,verify_metal_density,skip signoff,restore_design,skip signoff,save_design,replace_tcl}
...
set vars(timelib) {}
set vars(timelib,max) {inputs/adk/stdcells.lib}
set vars(timelib,min) {inputs/adk/stdcells.lib}
set vars(top) {0}
set vars(top_cell) {BGR_Top}
