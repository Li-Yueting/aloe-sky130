...
def construct():
  ...
  parameters = {
    ...
    'design_name'    : 'all_bgr_top',
    'clock_period'   : 100.0,
    'adk'            : adk_name,
    'adk_view'       : adk_view,
    'topographical'  : True,
    'testbench_name' : 'all_bgr_top_tb',
    'saif_instance'  : 'all_bgr_top_tb/all_bgr_top_inst',
    'dut_name'       : 'all_bgr_top_inst'
  }
  ...
  dc.extend_inputs(['analog.db'])
  # iflow.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef']);
  # init.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef']);
  # power.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef']);
  # place.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef']);
  # cts.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef']);
  # postcts_hold.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef']);
  # route.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef']);
  # postroute.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef']);
  # signoff.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef']);
  gdsmerge.extend_inputs(['bgr_0.gds','decoder5x32.gds','switch.gds'])
  # magic_def2spice.extend_inputs(['BR32.lef','BR64.lef','BR128.lef']);
  # magic_drc.extend_inputs(['BR32.lef','BR64.lef','BR128.lef']);  
  # magic_gds2spice.extend_inputs(['BR32.lef','BR64.lef','BR128.lef']);
  calibre_lvs.extend_inputs(['bgr_0.sp','decoder5x32.sp','switch.sp']); 
  ...
  g.connect_by_name( analog, 	      iflow	      )
  g.connect_by_name( analog, 	      init	      )
  g.connect_by_name( analog, 	      power	      )
  g.connect_by_name( analog, 	      place	      )
  g.connect_by_name( analog, 	      cts	      )
  g.connect_by_name( analog, 	      postcts_hold    )
  g.connect_by_name( analog, 	      route	      )
  g.connect_by_name( analog, 	      postroute	      )
  g.connect_by_name( analog, 	      signoff	      )
  g.connect_by_name( analog, 	      gdsmerge 	      )
  g.connect_by_name( analog, 	      magic_def2spice	      )
  g.connect_by_name( analog, 	      magic_drc	      )
  g.connect_by_name( analog, 	      magic_gds2spice	      )
  g.connect_by_name( analog, 	      calibre_lvs	      )
  g.connect_by_name( analog, 	      magic_drc	      )
