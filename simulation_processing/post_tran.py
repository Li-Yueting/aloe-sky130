...
data27 = s3r.read('../sims/post_bandgap_real_27degc_vbg.raw')
data0 = s3r.read('../sims/post_bandgap_real_0degc_vbg.raw')
data70 = s3r.read('../sims/post_bandgap_real_70degc_vbg.raw')
